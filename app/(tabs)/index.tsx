      ...
      <ScrollView className="flex-1">
        ...
        <View className="flex-row justify-between items-center px-5 pt-5 pb-4">
          <View className='max-w-[80%]' >
            ...
            <Text className="text-2xl font-bold text-black mt-1">{user?.name || 'User'}</Text>
          </View>
          <TouchableOpacity 
        ...
        <View className="bg-white mx-5 mb-6 p-5 rounded-xl border border-gray-200">
          <View className="flex-row justify-between items-center mb-2">
            <Text className="text-lg font-semibold text-black">Today&apos;s Health Status</Text>
          ...
          <Text className="text-sm text-gray-600">All vitals are within normal range</Text>
        </View>

        {/* Quick Actions */}
        <View className="mb-6">
          <Text className="text-xl font-semibold text-black mb-4 px-5">Quick Actions</Text>
          <View className="flex-row flex-wrap px-5 gap-3">
            {quickActions.map((action) => (
              ...
              >
                ...
                <Text className="text-sm font-medium text-black text-center">{action.title}</Text>
              </TouchableOpacity>
            ))}
          </View>
        </View>
        ...
        {/* Health Stats */}
        <View className="mb-6">
          <Text className="text-xl font-semibold text-black mb-4 px-5">Health Metrics</Text>
          <View className="px-5 space-y-3">
            {healthStats.map((stat, index) => (
              <View key={index} className="bg-white p-4 rounded-xl border border-gray-200">
                <View className="flex-row items-center mb-2">
                  <Ionicons name={stat.icon as any} size={20} color="black" />
                  <Text className="text-sm text-gray-600 ml-2">{stat.label}</Text>
                </View>
                <Text className="text-xl font-semibold text-black">{stat.value}</Text>
              </View>
            ))}
          </View>
        </View>
        ...
        <View className="mb-10">
          <Text className="text-xl font-semibold text-black mb-4 px-5">Recent Activity</Text>
          <View className="bg-white mx-5 rounded-xl border border-gray-200">
            <View className="flex-row items-center p-4 border-b border-gray-100">
              ...
              <View className="flex-1">
                <Text className="text-base font-medium text-black">Medication Taken</Text>
            ...
            <View className="flex-row items-center p-4 border-b border-gray-100">
              ...
              <View className="flex-1">
                <Text className="text-base font-medium text-black">Heart Rate Recorded</Text>
            ...
            <View className="flex-row items-center p-4">
              ...
              <View className="flex-1">
                <Text className="text-base font-medium text-black">Appointment Scheduled</Text>
