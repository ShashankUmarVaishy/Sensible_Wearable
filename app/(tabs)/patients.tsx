    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="flex-row px-5 mb-5 gap-3">
        <View className="flex-1 bg-white p-4 rounded-xl border border-gray-200 items-center">
          <Text className="text-2xl font-bold text-black mb-1">{patients.length}</Text>
              ...
              >
                <View className="flex-row items-center mb-4">
                  ...
                  <View className="flex-1">
                    <Text className="text-lg font-semibold text-black mb-1">{patient.name}</Text>
                ...
                <View className="mb-4 space-y-2">
                  <View className="flex-row items-center">
                    ...
                    <Text className="text-sm text-gray-600 ml-2">Age: {patient.age || 'N/A'}</Text>
                  </View>
                  <View className="flex-row items-center">
                    <Ionicons name="medical-outline" size={16} color="black" />
                    <Text className="text-sm text-gray-600 ml-2">{patient.condition || 'No condition specified'}</Text>
                  </View>
                  <View className="flex-row items-center">
                    <Ionicons name="time-outline" size={16} color="black" />
                    <Text className="text-sm text-gray-600 ml-2">Last: {patient.lastCheckup || 'No checkup'}</Text>
                  </View>
                </View>
